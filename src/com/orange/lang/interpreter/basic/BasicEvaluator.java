...
public class BasicEvaluator {
    ...
    public static class ASTListEx extends ASTList {
        public ASTListEx(List<ASTree> list) { super(list); }
    ...
    public static class IdentifierEx extends Identifier {
        public IdentifierEx(Token t) { super(t); }
    ...
    public static class NegativeEx extends NegativeExpr {
        public NegativeEx(List<ASTree> list) { super(list); }
    ...
    public static class BinaryEx extends BinaryExpr {
        public BinaryEx(List<ASTree> list) { super(list); }
    ...
    public static class BlockEx extends BlockStmnt {
        public BlockEx(List<ASTree> list) { super(list); }
    ...
    public static class IfEx extends IfStmnt {
        public IfEx(List<ASTree> list) { super(list); }
    ...
    public static class WhileEx extends WhileStmnt {
        public WhileEx(List<ASTree> list) { super(list); }
